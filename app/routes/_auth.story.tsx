...
const Story = () => {
  return (
    <div className="relative mx-auto flex w-full max-w-2xl flex-col gap-10 px-5 pb-10 lg:px-0">
      ...
      <div className="flex flex-col gap-32">
        ...
        >
          <p className="text-grey">
            ...
            a weekend with Rob and Rolf.
            <br />
            <br />
            Some of their most memorable adventures together include:
            bikepacking from Bergen to Oslo, getting haircuts in Berlin, a canal
            cruise in Amsterdam, clubbing in Madrid, more cycling in Italy,
            sunburns in Gran Canaria, the Pacific Coast Highway in the USA,
            cross country skiing in Norway, pizza slices in New York, getting
            lost in San Francisco, and celebrating Camilla's 25th birthday in
            Lithuania.
          </p>
        </StorySection>
        <StorySection
