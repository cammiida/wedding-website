  ...
  return (
    <>
      ...
      <div className="relative mx-auto flex w-full max-w-lg flex-col  px-5 pb-10 lg:px-0 lg:pt-20">
        ...
        <div className="flex flex-col gap-14">
          ...
          <section className="flex flex-col">
            ...
            <p className="text-grey">
              ...
              particularly adventurous, or you'd rather not fly, you can also
              get to Oslo via train, bus, car, and even boat.
            </p>
          </section>
          <section className="flex flex-col">
            <h2 className="pb-2 font-roboto text-2xl font-semibold group-hover:subpixel-antialiased	">
            ...
            <p className="text-grey">
              The drive from Oslo to Bygdin is beautiful! There is a bus that
              goes from central Oslo all the way to Bygdin called the{" "}
              <b>Valdresekspress</b> (line 161). It takes about 4 hours 15 mins
              and costs NOK 400-600 one-way, depending on the departure time.
              During the summer, there are between one and four buses running
              the route daily. You can book here:{" "}
              <a
              ...
              Vang, Innlandet. You can also drive your own car if you'd prefer
              and this takes about 3 hours 30 mins.
            </p>
          </section>
          <section className="flex flex-col">
            <h2 className="pb-2 font-roboto text-2xl font-semibold group-hover:subpixel-antialiased	">
        ...
        <div className="flex flex-col gap-14">
          <p className="text-grey">
            We will be staying at the hotel from Friday to Sunday, and as we
            have booked out the whole hotel, you will be staying at the hotel
            too. You can choose to stay as long as you'd like, and we would love
            to have you join us for the whole weekend if you can!
          </p>
          <section className="flex flex-col">
            <h2 className="pb-2 font-roboto text-2xl font-semibold group-hover:subpixel-antialiased	">
              Rooms
            ...
            <p className="text-grey">
              ...
              can specify your preference when RSVP'ing and we will do our best
              to accommodate it.
            </p>
